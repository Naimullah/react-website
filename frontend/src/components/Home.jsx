...
const Home=()=>{
    return(
        ...
        <header className="shadow">
            ...
            <Navbar expand="lg" className="">
                ...
                >
                    ...
                    <Nav.Link href="#action1">Womens</Nav.Link>
      ...
      <LatestProduct />
      <FeaturedProduct />
      <footer className='py-5 text-white mb-5'>
        <div className='container'>
            <div className='row'>
                <div className='col-md-3'>
                    <img src={LogoBlack} alt="" width={150} />
                    <div className='pt-3 pe-4'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aperiam impedit dicta magnam</div>
                </div>
                <div className='col-md-3'>
            ...
            <div className='row spotlight py-5'>
                ...
                <h3 className='ps-2'>Money Back Gurntee</h3>
                    </div>
                </div>
                <div className="col-md-4">
                <div className='d-flex justify-content-center'>
